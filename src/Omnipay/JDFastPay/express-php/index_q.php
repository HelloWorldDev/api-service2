...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name="payment" action="q.php" method="post" target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>交易类型：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="trade_type" value="Q"/>
                        <span>必填</span>
                    </dd>
                    <dt>交易ID：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="new-btn-login-sp">
                            <button class="new-btn-login" type="submit" style="text-align:center;">查询</button>
                        </span>
                    </dd>
                </dl>
            </div>
