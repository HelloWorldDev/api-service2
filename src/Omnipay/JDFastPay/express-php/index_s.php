...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name="payment" action="s.php" method="post" target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="trade_type" value="S"/>
                        <span>必填 （V：签约）</span>
                    </dd>
                    <dt>交易ID：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="trade_note" value="我要消费"/>
                        <span></span>
                    </dd>
                    <dt>验证码：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="trade_code" value="111111"/>
                        <span>必填(消费时，请输入真实手机验证码)</span>
                    </dd>

					<dt></dt>
                    <dd>
                        <span class="new-btn-login-sp">
                            <button class="new-btn-login" type="submit" style="text-align:center;">支付</button>
                        </span>
                    </dd>
                </dl>
            </div>
